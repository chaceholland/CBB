...
// Teams that failed (ESPN ID != logo ID)
const failedTeams = ['78', '92', '123', '148', '95', '115', '168', '136', '102', '176', '273', '414', '64'];
...
async function main() {
  console.log('Fixing logos for teams with mismatched ESPN IDs...\n');

  let fixed = 0, failed = 0;

  for (const teamId of failedTeams) {
    process.stdout.write(`  Getting info for team ${teamId}...`);
